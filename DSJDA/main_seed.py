...
if __name__ == '__main__':
    ...
    for session_id_main in range(3):
        for subject_id_main in range(15):
            ...
            acc,current_confusion_matrix = cross_subject(data_tmp, label_tmp, session_id_main, subject_id_main, category_number,
        ...
        csub_all = csub
        csub = []
    print("Cross-subject: ", csub_all)
    print("Cross-subject mean: ", np.mean(csub_all), "std: ", np.std(csub_all))
